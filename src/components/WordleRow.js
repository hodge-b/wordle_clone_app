    ...
    return(
        <div className="wordle-row">
            <WordleCell
                ...
                isTooManyOfGuessedLetter = {checkForCorrectLetterWrongCell(cell[0], props.target[0], props.target.split('')) && 
            ...
            <WordleCell
                ...
                isTooManyOfGuessedLetter = {checkForCorrectLetterWrongCell(cell[1], props.target[1], props.target.split('')) && 
            ...
            <WordleCell
                ...
                isTooManyOfGuessedLetter = {checkForCorrectLetterWrongCell(cell[2], props.target[2], props.target.split('')) &&
            ...
            <WordleCell
                ...
                isTooManyOfGuessedLetter = {checkForCorrectLetterWrongCell(cell[3], props.target[3], props.target.split('')) &&
            ...
            <WordleCell
                ...
                isTooManyOfGuessedLetter = {checkForCorrectLetterWrongCell(cell[4], props.target[4], props.target.split('')) &&
